...
public class MaterialConfig {
    ...
    CommandLineRunner initMaterials(MaterialRepository materialRepository) {
        return args -> {
            ...
            materialRepository.save(new Material("2600 R-Testliner", 0.4, 0.32, 0.0, 0.7, 0.0, 1, 0.0, 0.12, 3.6, 0.73, 13.3, 71.10711, false, false, Recyclingverfahren.CLOSED_LOOP, 0.0));
            materialRepository.save(new Material("2700 R-Schrenz", 0.4, 0.32, 0.0, 0.7, 0.0, 1, 0.0, 0.12, 3.6, 0.73, 13.3, 71.10711, false, false, Recyclingverfahren.CLOSED_LOOP, 0.0));
            ...
            materialRepository.save(new Material("2830 R-Karton GD", 1.1, 0.29, 0.0, 0.7, 0.0, 1, 0.0, 0.12, 3.1, 0.73, 12.4, 71.10711, false, false, Recyclingverfahren.CLOSED_LOOP, 0.0));
            materialRepository.save(new Material("2900 Glassine", 1.6, 1.1, 0.0, 0.7, 0.0, 1, 10.0, 0.12, 18.0, 0.76, 25.9, 0, false, true, Recyclingverfahren.CLOSED_LOOP, 0.0));
            ...
            materialRepository.save(new Material("3400 Hochofenstahl", 0.0, 0.0, 0.0, 0.71, 0.0, 7.8, 5.5, 0.0, 0, 1.6, 14.0, 0.0, false, true, Recyclingverfahren.CLOSED_LOOP, 0.0));
            materialRepository.save(new Material("3500 Elektrostahl", 0.0, 0.0, 0.0, 0.71, 0.0, 7.8, 5.5, 0.0, 0, 0.71, 5.5, 0.0, false, true, Recyclingverfahren.CLOSED_LOOP, 0.0));
            ...
            materialRepository.save(new Material("7810 Klebstoffe: PSA-Acrylat generic", 0.0, 0.0, 0.0, 0.41, 2.4, 1.38, 1.6, 1.8, 22.0, 2.5, 50.05, 0.0, false, false, Recyclingverfahren.OPEN_LOOP, 0.0));
