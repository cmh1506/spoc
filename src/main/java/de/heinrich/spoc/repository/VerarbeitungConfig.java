...
public class VerarbeitungConfig {
    ...
    CommandLineRunner initVerarbeitungs(VerarbeitungRepository verarbeitungRepository) {
        return args -> {
            verarbeitungRepository.save (new Verarbeitung("Keine Verarbeitung", 0.0, 0.0));
            ...
            verarbeitungRepository.save (new Verarbeitung("FlachfolienundReckanlage", 1.0, 1.0));
            ...
            verarbeitungRepository.save (new Verarbeitung("Spritzguss-und Streckblasformanlage", 3.06, 0.0));
            verarbeitungRepository.save (new Verarbeitung("Tiefziehen", 1.2, 0.0));
            verarbeitungRepository.save (new Verarbeitung("Folienherstellung und Tiefziehen", 2.3, 0.0));
            ...
            verarbeitungRepository.save (new Verarbeitung("Aluminium walzen", 11.0, 0.0));
        };
    }
}
